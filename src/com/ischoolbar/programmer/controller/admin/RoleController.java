...
public class RoleController {
	...
	public Map<String, Object> getList(Page page,
		...
		queryMap.put("offset", page.getOffset()); //对挺数据库的偏移量
		queryMap.put("pageSize", page.getRows());//每页的数量
		ret.put("rows", roleService.findList(queryMap)); //角色信息模糊分页搜索查询
		ret.put("total", roleService.getTotal(queryMap));//模糊查询角色总记录数
		return ret;
	}
