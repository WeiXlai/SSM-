...
public class SystemController {
	...
	public ModelAndView index(ModelAndView model, HttpServletRequest request){
		...
		model.addObject("topMenuList", MenuUtil.getAllTopMenu(userMenus));//一级菜单
		model.addObject("secondMenuList", MenuUtil.getAllSecondMenu(userMenus));//二级菜单
		model.setViewName("system/index");//WEB-INF/views/+system/index+.jsp = WEB-INF/views/system/index.jsp
		return model;
	}
